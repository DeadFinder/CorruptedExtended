...
if (CorruptedEnemiesEnabled["CorruptedEpicenterCursed"]) {
    ...
    KDEventMapBullet.bulletTick.CorruptedCursingCircle=(e,b,data)=>{if(KDUtilCommon.PlayerWearsRestraint(cRestraints.corruptedCursedEpicenterEncasement)||KDUtilCommon.AmountRestraintWithShrine("Shadow")<5||b.time>1)return;if(KDistChebyshev(KinkyDungeonPlayerEntity.x-b.x,KinkyDungeonPlayerEntity.y-b.y)<=e.aoe){let enemies=KDNearbyEnemies(KinkyDungeonPlayerEntity.x,KinkyDungeonPlayerEntity.y,e.aoe);const equippedRestraints=KinkyDungeonAllRestraint();KDBreakTether(KinkyDungeonPlayerEntity);KinkyDungeonPassOut(!0);KinkyDungeonAddRestraintIfWeaker(cRestraints.corruptedCursedEpicenterEncasement,0,!0,"Red",!1,undefined,undefined,"Corrupted",!0);for(const enemy of enemies){if(enemy.Enemy.name==="EpicenterCursed"){KinkyDungeonAddRestraintIfWeaker("CursedCollar",15,!0,"Red",!1,undefined,undefined,"Corrupted",!0);KDRemoveEntity(enemy);break}else if(enemy.Enemy.name==="EpicenterCursed2"){KinkyDungeonAddRestraintIfWeaker("CursedCollar2",15,!0,"Red",!1,undefined,undefined,"Corrupted",!0);KDRemoveEntity(enemy);break}}for(const restraint of equippedRestraints){if(restraint){if(restraint.name&&(restraint.name==="CursedCollar"||restraint.name==="CursedCollar2"||restraint.name===cRestraints.corruptedCursedEpicenterEncasement))continue;if(restraint.curse&&restraint.curse==="CursedDamage")continue;if(KDRandom()>.8){restraint.curse="CursedDamage";if(KDRandom()>.7){continue}break}}}}};
...
KDEventMapEnemy.beforeDamage[alchemistDomFlag]=(e,enemy,data)=>{const totalPetRestraints=KDUtilCommon.RestraintWithEnemyTagCount(petRestraintTag);let hasAlchemistLeash=!!KinkyDungeonInventoryGet(cRestraints.corruptedAlchemistLeash),hasAlchemistCollar=KDUtilCommon.PlayerWearsRestraint(cRestraints.corruptedAlchemistCollar),hasAlchemistGag=KDUtilCommon.PlayerWearsRestraint(cRestraints.corruptedAlchemistBallGag),hasLeash=KinkyDungeonIsWearingLeash(),hasCollar=KDUtilCommon.HasRestraintWithShrines("Collars"),hasGag=KDUtilCommon.HasRestraintWithShrines("Gags","FlatGags","BallGags");if(data.enemy===enemy&&data.target===KinkyDungeonPlayerEntity){let selectedRestraint="";if(data.restraintsAdded&&data.restraintsAdded.length===0){for(const res of aRestraintsNeed){if(!KDUtilCommon.PlayerWearsRestraint(res)){selectedRestraint=res;break}}}if(hasLeash&&!hasAlchemistLeash){KinkyDungeonRemoveRestraintsWithName("BasicLeash");KinkyDungeonRemoveRestraintsWithName("WolfLeash");KinkyDungeonRemoveRestraintsWithName("CorruptedSlimeLeash");KinkyDungeonSendTextMessage(1,`"Corrupted Alchemist" removes your leash!`,"white",3);selectedRestraint=""}if(hasCollar&&!hasAlchemistCollar&&selectedRestraint!==""){KinkyDungeonRemoveRestraintsWithShrine("Collars");KinkyDungeonSendTextMessage(1,`"Corrupted Alchemist" removes your collar!`,"white",3);selectedRestraint=""}if(hasGag&&!hasAlchemistGag&&selectedRestraint===""){KinkyDungeonRemoveRestraintsWithShrine("Gags");KinkyDungeonSendTextMessage(1,`"Corrupted Alchemist" removes your gag!`,"white",3);selectedRestraint=""}if(selectedRestraint!==""){KinkyDungeonAddRestraintIfWeaker(KinkyDungeonGetRestraintByName(selectedRestraint),0,!0,undefined,!1,undefined,undefined,"Corrupted",!0)}if(totalPetRestraints>5&&hasAlchemistLeash&&!KinkyDungeonFlags.get(alchemistDommedFlag)){if(KDGameData.PrisonerState!=='parole'){KDGameData.PrisonerState='parole';KinkyDungeonPassOut(!0);KinkyDungeonSetDress(CorruptedAlchemistPetDress,CorruptedAlchemistPetDress);if(!KinkyDungeonInventoryGet(CorruptedAlchemistPetDress)){let outfit={name:CorruptedAlchemistPetDress,id:KinkyDungeonGetItemID(),type:"Outfit"};KinkyDungeonInventoryAdd(outfit)}}KDBreakTether(KinkyDungeonPlayerEntity);KinkyDungeonAttachTetherToEntity(2,enemy);KinkyDungeonApplyBuffToEntity(KinkyDungeonPlayerEntity,{id:alchemistDommedFlag,type:"Flag",duration:20,power:1,maxCount:1,currentCount:1,tags:["attack","cast"],events:[{type:alchemistDommedFlag,trigger:"tickAfter"}]});if(!enemy.Enemy.summonEnemy){const nearbyPoint=KinkyDungeonGetNearbyPoint(enemy.x,enemy.y,!0,null,!0,!0);if(nearbyPoint){const inspectorEnemy=DialogueCreateEnemy(nearbyPoint.x,nearbyPoint.y,alchemistInspectorName);enemy.Enemy.summonEnemy=!0;KinkyDungeonSendTextMessage(1,`"Corrupted Alchemist" summons ${alchemistInspectorText}!`,"white",3)}}}}};

KDEventMapEnemy.beforeDamage[alchemistFactionDomFlag]=(e,enemy,data)=>{const totalPetRestraints=KDUtilCommon.RestraintWithEnemyTagCount(petRestraintTag);let hasAlchemistLeash=!!KinkyDungeonInventoryGet(cRestraints.corruptedAlchemistLeash);if(data.enemy===enemy&&data.target===KinkyDungeonPlayerEntity&&totalPetRestraints>5&&hasAlchemistLeash&&!KinkyDungeonFlags.get(alchemistDommedFlag)){KDBreakTether(KinkyDungeonPlayerEntity);KinkyDungeonAttachTetherToEntity(2,enemy);KinkyDungeonApplyBuffToEntity(KinkyDungeonPlayerEntity,{id:alchemistDommedFlag,type:"Flag",duration:20,power:1,maxCount:1,currentCount:1,tags:["attack","cast"],events:[{type:alchemistDommedFlag,trigger:"tickAfter"}]});}};

KDEventMapEnemy.afterEnemyTick[alchemistDomRefreshFlag]=(e,enemy,data)=>{if(KinkyDungeonFlags.get(alchemistDommedFlag)){let duration=2;KinkyDungeonSetFlag("TempLeash",duration);KinkyDungeonSetFlag("TempLeashCD",duration*2);KinkyDungeonSetFlag("noResetIntent",12);enemy.playWithPlayerCD=duration;enemy.IntentAction='TempLeash'}};

KDEventMapBuff.tickAfter[alchemistDommedFlag]=(e,buff,entity,data)=>{if(buff.duration>0&&entity.player){if(!KinkyDungeonInventoryGet(cRestraints.corruptedAlchemistLeash)){KDBreakTether(entity);KinkyDungeonExpireBuff(entity,alchemistDommedFlag)}}};
...
KDEventMapEnemy.beforeDamage.corruptedMaid=(e,enemy,data)=>{if(data.enemy===enemy&&data.target===KinkyDungeonPlayerEntity&&!data.restrainsAdded){if(KinkyDungeonFlags.get(corruptedMaidDomFlag))return;let restraintAdded=!1;for(const restraintName of restraintsToAddMaid){if(KDUtilCommon.PlayerWearsRestraint(restraintName))continue;const restraint=KinkyDungeonGetRestraintByName(restraintName);if(!restraint||!restraint.name){console.log("Corrupted maid couldn't find the restraint with name: ",restraintName);continue}if(KinkyDungeonAddRestraintIfWeaker(restraintName,0,!0,undefined,!1,undefined,undefined,undefined,!0)){restraintAdded=!0;break}}if(!restraintAdded){KinkyDungeonAttachTetherToEntity(1,enemy);let flagBuff={id:corruptedMaidDomFlag,type:"Flag",duration:10,power:1,maxCount:1,currentCount:1,tags:["attack","cast"],events:[{type:corruptedMaidDomFlag,trigger:"tickAfter"}]};if(KinkyDungeonCurrentDress!==corruptedMaidPetDress){KinkyDungeonAddRestraintIfWeaker(KinkyDungeonGetRestraintByName(dressingUpRestraint),0,!0,undefined,!1,undefined,undefined,"Corrupted",!0);KinkyDungeonSendTextMessage(1,`${corruptedMaidText} pushes you to ground and begins changing your outfit!`,"white",3);flagBuff.enemy=enemy}KinkyDungeonSetFlag("PlayerDommed",10);KinkyDungeonApplyBuffToEntity(KinkyDungeonPlayerEntity,flagBuff)}}};

KDEventMapBuff.tickAfter[corruptedMaidDomFlag]=(e,buff,entity,data)=>{if(buff.duration>0&&entity.player){if(!KinkyDungeonInventoryGet("CorruptedMaidCollar")){KDBreakTether(entity);KinkyDungeonExpireBuff(entity,corruptedMaidDomFlag);return}if(buff.enemy&&buff.duration===5){KinkyDungeonSetDress("None","None");KinkyDungeonSendTextMessage(1,`${corruptedMaidText} snapped your current outfit into void.`,"white",3)}KinkyDungeonSetFlag("PlayerDommed",2)}else if(buff.enemy){KDBreakTether(entity);KinkyDungeonSetDress(corruptedMaidPetDress,corruptedMaidPetDress);if(!KinkyDungeonInventoryGet(corruptedMaidPetDress)){let outfit={name:corruptedMaidPetDress,id:KinkyDungeonGetItemID(),type:"Outfit"};KinkyDungeonInventoryAdd(outfit)}KinkyDungeonMapParams[KinkyDungeonMapIndex[MiniGameKinkyDungeonCheckpoint]].defeat_outfit=corruptedMaidPetDress;KinkyDungeonRemoveRestraintsWithName("RopeSnakeHogtieWrist");KinkyDungeonSendTextMessage(1,`${corruptedMaidText} has transformed your outfit! +(Corrupted Maid Pet Outfit)`,"white",3);KinkyDungeonAttachTetherToEntity(2,buff.enemy);const tempLeashDuration=20;KinkyDungeonApplyBuffToEntity(KinkyDungeonPlayerEntity,{id:corruptedMaidDomFlag,type:"Flag",duration:tempLeashDuration,power:1,maxCount:1,currentCount:1,tags:["attack","cast"],events:[{type:corruptedMaidDomFlag,trigger:"tickAfter"}]});KinkyDungeonSetFlag("TempLeash",tempLeashDuration);KinkyDungeonSetFlag("TempLeashCD",tempLeashDuration*2);KinkyDungeonSetFlag("noResetIntent",12);buff.enemy.playWithPlayerCD=tempLeashDuration;buff.enemy.IntentAction="TempLeash"}else{KDBreakTether(entity);KinkyDungeonExpireBuff(entity,corruptedMaidDomFlag)}};
...
KDEventMapEnemy.beforeDamage.corruptedMummy=(e,enemy,data)=>{if(data.enemy===enemy&&data.target===KinkyDungeonPlayerEntity&&!data.restrainsAdded){if(!KDUtilCommon.PlayerWearsRestraint("CorruptedMummyCollar")){const restraint=KinkyDungeonGetRestraintByName("CorruptedMummyCollar");if(KDRandom()>=.7){KinkyDungeonAddRestraintIfWeaker(restraint,0,!0,"Divine2",!1,undefined,undefined,"Corrupted",!0)}}}};
...
KDEventMapEnemy.beforeDamage.cubeEngulf=(e,enemy,data)=>{const totalSlimeRestraints=KDUtilCommon.RestraintWithEnemyTagCount("latexEncaseRandom");if(data.enemy===enemy&&data.target===KinkyDungeonPlayerEntity&&totalSlimeRestraints>3&&!KinkyDungeonFlags.get(engulfFlag)){KDTripleBuffKill("CubeEngulf",KinkyDungeonPlayerEntity,9,(tt)=>{KinkyDungeonSetDress("SlimeDress","SlimeDress");KDBreakTether(KinkyDungeonPlayerEntity);KDRemoveEntity(enemy);KinkyDungeonRemoveRestraintsWithShrine("Slime");KinkyDungeonRemoveRestraintsWithShrine("SlimeHard");KinkyDungeonRemoveRestraintsWithShrine("Latex");KinkyDungeonAddRestraintIfWeaker(KinkyDungeonGetRestraintByName(cRestraints.corruptedCubeEncasement),0,!0,undefined,!1,undefined,undefined,"Corrupted",!0);KinkyDungeonAddRestraintIfWeaker(KinkyDungeonGetRestraintByName(cRestraints.corruptedCubeCuffs),0,!0,undefined,!1,undefined,undefined,"Corrupted",!0);KinkyDungeonAddRestraintIfWeaker(KinkyDungeonGetRestraintByName(cRestraints.corruptedCubeBallGag),0,!0,undefined,!1,undefined,undefined,"Corrupted",!0);KinkyDungeonAddRestraintIfWeaker(KinkyDungeonGetRestraintByName(cRestraints.corruptedCubeLeash),0,!0,undefined,!1,undefined,undefined,"Corrupted",!0);KinkyDungeonAddRestraintIfWeaker(KinkyDungeonGetRestraintByName(cRestraints.corruptedCubeBlindfold),0,!0,undefined,!1,undefined,undefined,"Corrupted",!0)},"Blindness")}};
